...
| Side | Pitcher | Starts | K/start | K/BF | Opp K% | Proj K | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| HOME | Andre Pallante | 5 | 4.0 | 0.177 | — | **3.89** | ok |
| AWAY | MacKenzie Gore | 5 | 4.0 | 0.189 | — | **4.16** | ok |

**Pitcher walks projections**
| Side | Pitcher | Starts | BB/start | BB/BF | Opp BB% | Proj BB | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| HOME | Andre Pallante | 5 | 1.4 | 0.062 | — | **1.36** | ok |
| AWAY | MacKenzie Gore | 5 | 1.8 | 0.085 | — | **1.87** | ok |
...
| Side | Pitcher | Starts | K/start | K/BF | Opp K% | Proj K | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| HOME | George Kirby | 5 | 5.0 | 0.205 | 21.1% | **4.33** | ok |
| AWAY | Freddy Peralta | 5 | 5.2 | 0.215 | 21.8% | **4.69** | ok |

**Pitcher walks projections**
| Side | Pitcher | Starts | BB/start | BB/BF | Opp BB% | Proj BB | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| HOME | George Kirby | 5 | 1.2 | 0.049 | 10.3% | **1.31** | ok |
| AWAY | Freddy Peralta | 5 | 2.4 | 0.099 | 8.9% | **2.28** | ok |

**Top batter walk projections**
| Side | Order | Batter | BB% | PA | Proj BB | Quality |
|---|---:|---|---:|---:|---:|---|
| HOME | 1 | J.P. Crawford | 15.1% | 159 | **0.774** | ok |
| HOME | 2 | Julio Rodríguez | 5.6% | 198 | **0.28** | ok |
| HOME | 3 | Josh Naylor | 9.0% | 178 | **0.44** | ok |
| HOME | 4 | Randy Arozarena | 9.3% | 194 | **0.433** | ok |
| HOME | 5 | Luke Raley | 5.6% | 161 | **0.254** | ok |
| AWAY | 1 | Carson Benge | 7.1% | 182 | **0.234** | ok |
| AWAY | 2 | Bo Bichette | 6.2% | 195 | **0.2** | ok |
| AWAY | 3 | Juan Soto | 15.3% | 118 | **0.482** | ok |
| AWAY | 4 | Jared Young | 14.3% | 42 | **0.429** | small_sample |
| AWAY | 5 | Brett Baty | 8.6% | 163 | **0.252** | ok |
...
| Side | Pitcher | Starts | K/start | K/BF | Opp K% | Proj K | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| HOME | Gerrit Cole | 2 | 6.0 | 0.267 | — | **5.87** | stale |
| AWAY | Gavin Williams | 5 | 7.0 | 0.265 | — | **5.83** | ok |

**Pitcher walks projections**
| Side | Pitcher | Starts | BB/start | BB/BF | Opp BB% | Proj BB | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| HOME | Gerrit Cole | 2 | 1.5 | 0.067 | — | **1.47** | stale |
| AWAY | Gavin Williams | 5 | 1.0 | 0.038 | — | **0.84** | ok |
...
| Side | Order | Batter | BB% | PA | Proj BB | Quality |
|---|---:|---|---:|---:|---:|---|
| HOME | 1 | Byron Buxton | 7.0% | 171 | **0.385** | ok |
| HOME | 2 | Brooks Lee | 6.1% | 147 | **0.328** | ok |
...
| Side | Pitcher | Starts | K/start | K/BF | Opp K% | Proj K | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| AWAY | Logan Webb | 2 | 4.5 | 0.225 | — | **4.95** | stale |

**Pitcher walks projections**
| Side | Pitcher | Starts | BB/start | BB/BF | Opp BB% | Proj BB | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| AWAY | Logan Webb | 2 | 1.5 | 0.075 | — | **1.65** | stale |
...
| Side | Pitcher | Starts | K/start | K/BF | Opp K% | Proj K | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| HOME | Walbert Ureña | 5 | 4.8 | 0.209 | — | **4.6** | ok |
| AWAY | Michael Lorenzen | 5 | 3.8 | 0.165 | — | **3.63** | ok |

**Pitcher walks projections**
| Side | Pitcher | Starts | BB/start | BB/BF | Opp BB% | Proj BB | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| HOME | Walbert Ureña | 5 | 2.4 | 0.104 | — | **2.29** | ok |
| AWAY | Michael Lorenzen | 5 | 2.2 | 0.096 | — | **2.11** | ok |
...
| Side | Pitcher | Starts | K/start | K/BF | Opp K% | Proj K | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| HOME | Spencer Arrighetti | 4 | 4.5 | 0.184 | — | **4.05** | ok |
| AWAY | Paul Skenes | 5 | 7.2 | 0.293 | — | **6.45** | ok |

**Pitcher walks projections**
| Side | Pitcher | Starts | BB/start | BB/BF | Opp BB% | Proj BB | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| HOME | Spencer Arrighetti | 4 | 3.0 | 0.122 | — | **2.68** | ok |
| AWAY | Paul Skenes | 5 | 1.0 | 0.041 | — | **0.9** | ok |
...
| Side | Pitcher | Starts | K/start | K/BF | Opp K% | Proj K | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| HOME | Colin Rea | 5 | 3.8 | 0.165 | — | **3.99** | ok |
| AWAY | Jeffrey Springs | 5 | 4.4 | 0.185 | — | **4.07** | ok |

**Pitcher walks projections**
| Side | Pitcher | Starts | BB/start | BB/BF | Opp BB% | Proj BB | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| HOME | Colin Rea | 5 | 2.2 | 0.096 | — | **2.11** | ok |
| AWAY | Jeffrey Springs | 5 | 1.6 | 0.067 | — | **1.47** | ok |
...
| Side | Pitcher | Starts | K/start | K/BF | Opp K% | Proj K | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| HOME | Zac Gallen | 5 | 4.4 | 0.183 | — | **4.03** | ok |
| AWAY | Shohei Ohtani | 4 | 6.75 | 0.287 | — | **6.31** | ok |

**Pitcher walks projections**
| Side | Pitcher | Starts | BB/start | BB/BF | Opp BB% | Proj BB | Quality |
|---|---|---:|---:|---:|---:|---:|---|
| HOME | Zac Gallen | 5 | 1.6 | 0.067 | — | **1.47** | ok |
| AWAY | Shohei Ohtani | 4 | 2.0 | 0.085 | — | **1.87** | ok |